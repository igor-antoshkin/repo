...
class UserLogin extends CFormModel
{
	...
	public function rules()
	{
		return array(
			...
			array('username, password, addr, ll', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'addr'=>UserModule::t("Where are you located now?"),
		);
	}
	...
	public function authenticate($attribute,$params)
	{
		...
		{
			$identity=new UserIdentity($this->username,$this->password, $this->ll, $this->addr);
